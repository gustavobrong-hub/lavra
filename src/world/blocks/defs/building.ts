...
export interface DyeColor { id: string; label: string; labelF: string; rgb: number }
export const COLORS: DyeColor[] = [
  { id: 'white', label: 'branco', labelF: 'branca', rgb: 0xf0f0f0 },
  { id: 'orange', label: 'laranja', labelF: 'laranja', rgb: 0xf07613 },
  { id: 'magenta', label: 'magenta', labelF: 'magenta', rgb: 0xbd44b3 },
  { id: 'light_blue', label: 'azul-claro', labelF: 'azul-clara', rgb: 0x3aafd9 },
  { id: 'yellow', label: 'amarelo', labelF: 'amarela', rgb: 0xf8c627 },
  { id: 'lime', label: 'verde-limão', labelF: 'verde-limão', rgb: 0x70b919 },
  { id: 'pink', label: 'rosa', labelF: 'rosa', rgb: 0xed8dac },
  { id: 'gray', label: 'cinza', labelF: 'cinza', rgb: 0x3e4447 },
  { id: 'light_gray', label: 'cinza-claro', labelF: 'cinza-clara', rgb: 0x8e8e86 },
  { id: 'cyan', label: 'ciano', labelF: 'ciano', rgb: 0x158991 },
  { id: 'purple', label: 'roxo', labelF: 'roxa', rgb: 0x792aac },
  { id: 'blue', label: 'azul', labelF: 'azul', rgb: 0x35399d },
  { id: 'brown', label: 'marrom', labelF: 'marrom', rgb: 0x724728 },
  { id: 'green', label: 'verde', labelF: 'verde', rgb: 0x546d1b },
  { id: 'red', label: 'vermelho', labelF: 'vermelha', rgb: 0xa12722 },
  { id: 'black', label: 'preto', labelF: 'preta', rgb: 0x141519 },
];
...
export const BUILDING: BlockDef[] = [
  ...
  // cores
  ...COLORS.map((c): BlockDef => ({ name: `${c.id}_wool`, label: `Lã ${c.labelF}`, hardness: 0.8, tool: 'shears', sound: 'wool', tex: `${c.id}_wool`, flammable: [30, 60], tab: 'build', data: { color: c.id } })),
  ...
  ...COLORS.map((c): BlockDef => ({ name: `${c.id}_terracotta`, label: `Terracota ${c.labelF}`, hardness: 1.25, ...stoneLike, resistance: 4.2, tex: `${c.id}_terracotta`, tab: 'build', data: { color: c.id } })),
  ...
  ...COLORS.map((c): BlockDef => ({ name: `${c.id}_bed`, label: `Cama ${c.labelF}`, hardness: 0.2, sound: 'wood', shape: 'bed', layer: 'solid', opaque: false, props: [FACING4, BED_PART, OCCUPIED], tex: { side: `${c.id}_wool`, bottom: 'oak_planks' }, tab: 'deco', data: { color: c.id } })),
];
